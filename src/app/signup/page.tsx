...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirect to a verification pending page or search params version
        ...
        <div className="min-h-screen bg-gradient-to-br from-stone-950 via-stone-900 to-amber-950 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-stone-400">Join the investigation</p>
                </div>

                {/* Signup Card */}
                <div className="bg-stone-900/50 backdrop-blur-sm border border-amber-900/30 rounded-xl p-8 shadow-2xl">
                    <h2 className="text-2xl font-bold text-stone-200 mb-6">Create Account</h2>
                    ...
                    <p className="mt-6 text-center text-sm text-stone-400">
                        ...
                        <Link href="/login" className="text-amber-500 hover:text-amber-400 font-medium transition">
                            Sign in
                        </Link>
                    </p>
                </div>
